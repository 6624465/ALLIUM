...
namespace NetStock.DataFactory
{
    public class ARInvoiceDAL
    {
        ...
        public IContract GetItem<T>(IContract lookupItem) where T : IContract
        {
            ...
            if (arinvoiceItem != null)
            {
                arinvoiceItem.ARInvoiceDetails = new NetStock.DataFactory.ARInvoiceDetailDAL().GetListByDocumentNo(arinvoiceItem.DocumentNo);

                arinvoiceItem.GLTransactionDetails = new NetStock.DataFactory.GLTransactionDAL().GetList(arinvoiceItem.DocumentNo);
            }
