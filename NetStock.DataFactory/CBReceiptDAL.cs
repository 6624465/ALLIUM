...
namespace NetStock.DataFactory
{
    public class CBReceiptDAL
    {
        ...
        public IContract GetItem<T>(IContract lookupItem) where T : IContract
        {
            ...
            if (cbreceiptItem != null)
            {
                cbreceiptItem.CBReceiptDetails = new NetStock.DataFactory.CBReceiptDetailDAL().GetListByDocumentNo(cbreceiptItem.DocumentNo);
                cbreceiptItem.CBReceiptSetOffDetails = new NetStock.DataFactory.CBReceiptSetOffDetailDAL().GetListByDocumentNo(cbreceiptItem.DocumentNo);
                cbreceiptItem.CBReceiptGLDetails = new NetStock.DataFactory.CBReceiptGlDetailDAL().GetListByDocumentNo(cbreceiptItem.DocumentNo);
            }
