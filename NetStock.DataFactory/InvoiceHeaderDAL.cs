...
namespace NetStock.DataFactory
{
    public class InvoiceHeaderDAL
    {
        ...
        public List<UnbilledDetail> InvoiceInquiry(UnbilledHeader item, short branchID)
        {
        ...
        public bool Save<T>(T item) where T : IContract
        {
            ...
            try
            {
                ...
                db.AddInParameter(savecommand, "PaymentDate", System.Data.DbType.DateTime, DateTime.Now);
                db.AddInParameter(savecommand, "DueDate", System.Data.DbType.DateTime, DateTime.Now);
                ...
                db.AddInParameter(savecommand, "OrderNo", System.Data.DbType.String, invoiceheader.OrderNo);
