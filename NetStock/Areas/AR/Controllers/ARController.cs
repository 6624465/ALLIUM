...
namespace NetStock.Areas.AR.Controllers
{
    [RouteArea("AR")]
    [SessionFilter]
    public class ARController : Controller
    {
        ...
        public ActionResult DebtorProfile(string debtorCode)
        {
            ...
            var debtor = new NetStock.BusinessFactory.DebtorBO().GetDebtor(new Debtor { DebtorCode = debtorCode });
        ...
        public JsonResult DeleteDebtor(string debtorCode)
        {
            ...
            try
            {
                result = new NetStock.BusinessFactory.DebtorBO().DeleteDebtor(new Debtor { DebtorCode = debtorCode });
        ...
        public ActionResult SearchDebtor(string debtorCode)
        {
            if (debtorCode != "")
            {
                ...
                debtor = new NetStock.BusinessFactory.DebtorBO().GetDebtor(new Debtor { DebtorCode = debtorCode });
        ...
        public JsonResult DeleteARInvoice(string documentNo, string cancelBy)
        {
            ...
            try
            {
                result = new NetStock.BusinessFactory.ARInvoiceBO().DeleteARInvoice(new ARInvoice { DocumentNo = documentNo, CancelledBy = cancelBy });
            }
            catch (Exception ex)
            {
                ModelState.AddModelError("Error", ex.Message);
        ...
        public ActionResult ARInvoice(string documentNo)
        {
            ...
            else
            {
                ...
                {
                    arInvoice = new NetStock.BusinessFactory.ARInvoiceBO().GetARInvoice(new ARInvoice { DocumentNo = documentNo });
        ...
        public ActionResult AddARInvoiceItem(string documentNo, Int16 itemNo)
        {
            ...
            {
                arInvoicedetail = new NetStock.BusinessFactory.ARInvoiceBO().GetARInvoice(new Contract.ARInvoice { DocumentNo = documentNo })
        ...
        [HttpPost]
        public JsonResult SaveARCreditNote(NetStock.Contract.ARCreditNote ARCreditNoteData)
        {
            try
            {
                ...
                var result = new NetStock.BusinessFactory.ARCreditNoteBO().SaveARCreditNote(ARCreditNoteData);
        ...
        public JsonResult DeleteARCreditNote(string documentNo, string cancelBy)
        {
            ...
            try
            {
                result = new NetStock.BusinessFactory.ARCreditNoteBO().DeleteARCreditNote(new ARCreditNote { DocumentNo = documentNo, CancelledBy = cancelBy });
            }
            catch (Exception ex)
            {
                ModelState.AddModelError("Error", ex.Message);
        ...
        public ActionResult ARCreditNote(string invoiceType, string documentNo)
        {
            ...
            else
            {
                ...
                {
                    ARCreditNote = new NetStock.BusinessFactory.ARCreditNoteBO().GetARCreditNote(new ARCreditNote { DocumentNo = documentNo });
                    ARCreditNote.AccountCodeList = Utility.GetAccountCodeItemList();
                }
                else
                {
        ...
        public ActionResult AddARCreditNoteItem(string documentNo, Int16 itemNo)
        {
            ...
            {
                ARCreditNotedetail = new NetStock.BusinessFactory.ARCreditNoteBO().GetARCreditNote(new Contract.ARCreditNote { DocumentNo = documentNo })
        ...
        [HttpPost]
        public JsonResult SaveARDebitNote(NetStock.Contract.ARDebitNote ARDebitNoteData)
        {
            try
            {
                ...
                var result = new NetStock.BusinessFactory.ARDebitNoteBO().SaveARDebitNote(ARDebitNoteData);
        ...
        public JsonResult DeleteARDebitNote(string documentNo, string cancelBy)
        {
            ...
            try
            {
                result = new NetStock.BusinessFactory.ARDebitNoteBO().DeleteARDebitNote(new ARDebitNote { DocumentNo = documentNo, CancelledBy = cancelBy });
            }
            catch (Exception ex)
            {
                ModelState.AddModelError("Error", ex.Message);
        ...
        public ActionResult ARDebitNote(string invoiceType, string documentNo)
        {
            ...
            else
            {
                ...
                if (documentNo != null && documentNo != "" && documentNo != "null")
                {
                    ARDebitNote = new NetStock.BusinessFactory.ARDebitNoteBO().GetARDebitNote(new ARDebitNote { DocumentNo = documentNo });
        ...
        public ActionResult AddARDebitNoteItem(string documentNo, Int16 itemNo)
        {
            ...
            {
                ARDebitNotedetail = new NetStock.BusinessFactory.ARDebitNoteBO().GetARDebitNote(new Contract.ARDebitNote { DocumentNo = documentNo })
