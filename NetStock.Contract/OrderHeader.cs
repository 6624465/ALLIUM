...
namespace NetStock.Contract
{
    public class OrderHeader : IContract
    {
        ...
        //public IEnumerable<SelectListItem> SalesLeadList { get; set; }

        //public IEnumerable<SelectListItem> DeliveryLocationList { get; set; }
        ...
        public IEnumerable<SelectListItem> SalesOrderTypeList { get; set; }
